...
public class AccountInfo {
    ...
    public String getIDCardUrlFront() {
        return IDCardUrlFront;
    }

    public void setIDCardUrlFront(String IDCardUrlFront) {
        this.IDCardUrlFront = IDCardUrlFront;
    }
    ...
    public String getDynamicVideoUrl() {
        return DynamicVideoUrl;
    }

    public void setDynamicVideoUrl(String DynamicVideoUrl) {
        this.DynamicVideoUrl = DynamicVideoUrl;
    }
