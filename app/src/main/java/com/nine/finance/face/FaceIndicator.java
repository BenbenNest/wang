...
public class FaceIndicator extends View {
	...
	private float IDCARD_RATIO = 856.0f / 856.0f;
	...
	public FaceIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public FaceIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
