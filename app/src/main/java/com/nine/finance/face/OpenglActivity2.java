...
import com.nine.finance.face.util.DialogUtil;
import com.nine.finance.face.util.ICamera;
...
public class OpenglActivity2 extends Activity
    ...
    public static void startActivity(Activity context) {
        ...
        context.startActivityForResult(new Intent(context, OpenglActivity2.class).putExtra("FaceAction", faceActionInfo), 101);
    }
        ...
        btnAddFeature.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (compareFaces == null || compareFaces.length <= 0 || carmeraImgData == null) {
                    Toast.makeText(OpenglActivity2.this, "当前未检测到人脸", Toast.LENGTH_SHORT).show();
                    return;
                }

//                Log.e("xie","xie rect"+compareFaces[0].rect.top+"bottom"+compareFaces[0].rect.bottom+newestFeature);

//                FaceCompareManager.instance().startActivity(OpenglActivity2.this, compareFaces, mICamera, carmeraImgData, isBackCamera, faceActionInfo);
            }
        });
                            ...
                            public void run() {
                                if (tvFeatures.size() < faces.length) {
                                    ...
                                    for (int i = 0; i < faces.length - tvFeaturesSize; i++) {
                                        TextView textView = new TextView(OpenglActivity2.this);
                        ...
                        for (int c = 0; c < faces.length; c++) {
                            ...
                            if (isFaceCompare) {
                                ...
                                if (facepp.getExtractFeature(face)) {
                                    synchronized (OpenglActivity2.this) {
